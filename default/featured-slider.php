...
<div class='one-swipe-image' style='visibility: hidden;'>
	<a href='<?php echo the_permalink(); ?>' class='needsclick'>
		...
		<?php /*重定向以前使用,<img src='<?php echo foundation_featured_get_image(); ?>' alt='<?php the_title(); ?>' / > */ ?>
		<img src='<?php echo str_replace(home_url('/wp-content').'/uploads',sahinn_blog_m_source_f().'/uploads', foundation_featured_get_image());  ?>' alt='<?php the_title(); ?>' / >
